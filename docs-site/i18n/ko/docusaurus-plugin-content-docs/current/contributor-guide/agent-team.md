...
| **`scan-pipeline-specialist`** | Celery 태스크, cdxgen / ORT / Trivy / Dependency-Track 통합, DT 회로 차단기. | Phase 2 |
...
3. **DT(Dependency-Track) API 호출** — DT로의 아웃바운드 요청, 회로 차단기, 캐시 fallback, 고아 프로젝트 정리.
